...
TEST_IMAGE_PATHS = [os.path.join(PATH_TO_TEST_IMAGES_DIR, '{}.jpg'.format(i)) for i in range(0, 40)]  # adjust range for # of images in folder
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
            ...
            plt.savefig("outputs/{}.jpg".format(i))  # create an outputs folder for the images to be saved
